<!-- Banner: vector only — `resources/readme-banner.svg`. VSIX uses README.vsix.md (Marketplace tooling blocks SVG in packaged README). -->
<p align="center">
  <img src="./resources/readme-banner.svg" alt="ASI1 Code — VS Code extension banner" width="100%" />
</p>
