 ...
 */
export function convertApplyPatchToolCalls(messages: Array<AsiStorageMessage>): Array<AsiStorageMessage> {
 ...
 */
export function convertWriteToFileToolCalls(messages: Array<AsiStorageMessage>): Array<AsiStorageMessage> {
	// Map to track tool_use_id to converted tool info and original input
