...
export async function refreshWorkflowToggles(
	...
	const globalAsiWorkflowsFilePath = await ensureWorkflowsDirectoryExists()
	const updatedGlobalWorkflowToggles = await synchronizeRuleToggles(globalAsiWorkflowsFilePath, globalWorkflowToggles)
