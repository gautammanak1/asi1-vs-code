...
// 'Add to Asi' context menu in editor and code action
// Inserts the selected code into the chat.
export async function addToAsi(controller: Controller, request: CommandContext, notebookContext?: string): Promise<Empty> {
	...
	Logger.log("addToAsi", request.selectedText, filePath, request.language)
