import type { ToggleAgentsRuleRequest } from "@shared/proto/asi/file"
 ...
 */
export async function toggleAgentsRule(controller: Controller, request: ToggleAgentsRuleRequest): Promise<AsiRulesToggles> {
