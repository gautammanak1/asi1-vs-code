import type { ToggleCursorRuleRequest } from "@shared/proto/asi/file"
 ...
 */
export async function toggleCursorRule(controller: Controller, request: ToggleCursorRuleRequest): Promise<AsiRulesToggles> {
