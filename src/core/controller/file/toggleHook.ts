import { ToggleHookRequest, ToggleHookResponse } from "@shared/proto/Asi/file";
...
export async function toggleHook(
	...
	// Planned improvement: persist enabled/disabled in JSON so Windows matches Unix without chmod.
