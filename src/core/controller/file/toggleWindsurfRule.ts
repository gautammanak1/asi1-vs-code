import type { ToggleWindsurfRuleRequest } from "@shared/proto/asi/file"
import { AsiRulesToggles } from "@shared/proto/asi/file"
 ...
 */
export async function toggleWindsurfRule(controller: Controller, request: ToggleWindsurfRuleRequest): Promise<AsiRulesToggles> {
	...
	return AsiRulesToggles.create({ toggles: toggles })
}
