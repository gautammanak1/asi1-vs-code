import { AsiRulesToggles, RuleScope, ToggleWorkflowRequest } from "@shared/proto/asi/file"
 ...
 */
export async function toggleWorkflow(controller: Controller, request: ToggleWorkflowRequest): Promise<AsiRulesToggles> {
