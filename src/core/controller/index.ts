...
export class Controller {
	...
	*/
	...
	async getStateToPostToWebview(): Promise<ExtensionState> {
		...
		const globalAsiRulesToggles = this.stateManager.getGlobalSettingsKey(
		...
		const localAsiRulesToggles = this.stateManager.getWorkspaceStateKey(
		...
		const AsiMessages = [
			...(this.task?.messageStateHandler.getAsiMessages() || []),
		];
