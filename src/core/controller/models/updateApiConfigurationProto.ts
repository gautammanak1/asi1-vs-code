	...
	try {
		...
		const convertedApiConfigurationFromProto = {
			...
			planModeOpenRouterModelInfo: protoApiConfiguration.planModeOpenRouterModelInfo
				...
				: undefined,
			planModeAsiModelInfo: protoApiConfiguration.planModeAsiModelInfo
				? fromProtobufModelInfo(protoApiConfiguration.planModeAsiModelInfo)
				: undefined,
			...
			actModeOpenRouterModelInfo: protoApiConfiguration.actModeOpenRouterModelInfo
				...
				: undefined,
			actModeAsiModelInfo: protoApiConfiguration.actModeAsiModelInfo
				? fromProtobufModelInfo(protoApiConfiguration.actModeAsiModelInfo)
				: undefined,
