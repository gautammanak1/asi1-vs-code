...
import { AsiMessage } from "@shared/proto/asi/ui"
import { Logger } from "@/shared/services/Logger"
import { getRequestRegistry, StreamingResponseHandler } from "../grpc-handler"
import { Controller } from "../index"

// Keep track of active partial message subscriptions (gRPC streams)
const activePartialMessageSubscriptions = new Set<StreamingResponseHandler<AsiMessage>>()

// Keep track of callback-based subscriptions (for CLI and other non-gRPC consumers)
export type PartialMessageCallback = (message: AsiMessage) => void
...
export async function subscribeToPartialMessage(
	...
	responseStream: StreamingResponseHandler<AsiMessage>,
	requestId?: string,
): Promise<void> {
 ...
 * @param partialMessage The AsiMessage to send
 */
export async function sendPartialMessageEvent(partialMessage: AsiMessage): Promise<void> {
