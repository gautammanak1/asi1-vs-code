 ...
 * provide--the other common parameters like AsiVersion and userId are handled by the
 * hook system.
 */
...
export abstract class HookRunner<Name extends HookName> {
	 ...
	 * - AsiVersion: Current Asi extension version
	 ...
	 * - userId: Asi user ID, machine ID, or generated UUID
	 *
 ...
 *
 * Used in multi-root workspaces where both global hooks (from ~/Documents/asi/Hooks/)
 * and workspace-specific hooks (from each workspace's .Asirules/hooks/) exist for the
 * same hook type.
 *
 * Behavior:
...
export class HookFactory {
	 ...
	 *
	 * - Global hooks (from ~/Documents/asi/Hooks/): run from the primary workspace root
	 * - Workspace hooks (from workspaceRoot/.Asirules/hooks/): run from that specific workspace root
	 *
	 ...
	 * Global hooks are located in ~/Documents/asi/Hooks/
	 * Workspace hooks are located in workspace .Asirules/hooks/ directories
	 *
	 ...
	 * Includes both global hooks (from ~/Documents/asi/Hooks/) and workspace hooks
	...
	/**
	 * Finds the path to a hook in a .Asirules hooks directory.
	 *
	 * @param hookName the name of the hook to search for, for example 'PreToolUse'
	 * @param hooksDir the .Asirules directory path to search
