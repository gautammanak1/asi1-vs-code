...
function buildUserInstructions(
	globalAsiRulesFileInstructions?: string,
	localAsiRulesFileInstructions?: string,
	localCursorRulesFileInstructions?: string,
	localCursorRulesDirInstructions?: string,
	localWindsurfRulesFileInstructions?: string,
	localAgentsRulesFileInstructions?: string,
	AsiIgnoreInstructions?: string,
	...
	if (globalAsiRulesFileInstructions) {
		customInstructions.push(globalAsiRulesFileInstructions)
	}
	if (localAsiRulesFileInstructions) {
		customInstructions.push(localAsiRulesFileInstructions)
	}
	...
	if (AsiIgnoreInstructions) {
		customInstructions.push(AsiIgnoreInstructions)
	}
