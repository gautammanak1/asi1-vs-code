...
import { AsiToolSet } from "../registry/ClineToolSet"
import { type AsiToolSpec, resolveInstruction } from "../spec"
...
export class PromptBuilder {
	...
	private static getEnabledTools(variant: PromptVariant, context: SystemPromptContext): AsiToolSpec[] {
		return AsiToolSet.getEnabledToolSpecs(variant, context)
	}
	...
	public static tool(config: AsiToolSpec, registry: AsiDefaultTool[], context: SystemPromptContext): string {
