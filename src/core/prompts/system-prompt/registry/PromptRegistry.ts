...
import { AsiToolSet } from ".."
import { getSystemPromptComponents } from "../components"
import { registerAsiToolSets } from "../tools"
...
export class PromptRegistry {
	...
	public nativeTools: AsiTool[] | undefined = undefined
	...
	async get(context: SystemPromptContext): Promise<string> {
		...
		this.nativeTools = AsiToolSet.getNativeTools(variant, context)
