...
export interface PromptVariant {
	...
	// Tool configuration
	readonly tools?: readonly AsiDefaultTool[] // Ordered list of tools to include
	readonly toolOverrides?: Readonly<Partial<Record<AsiDefaultTool, ConfigOverride>>> // Tool customizations
}
...
export interface MutablePromptVariant {
	...
	tools?: AsiDefaultTool[]
	toolOverrides?: Partial<Record<AsiDefaultTool, ConfigOverride>>
}
...
export interface PromptConfig {
	...
	readonly tools?: readonly AsiToolSpec[]
...
export interface SystemPromptContext {
	...
	readonly globalAsiRulesFileInstructions?: string
	readonly localAsiRulesFileInstructions?: string
	...
	readonly AsiIgnoreInstructions?: string
	...
	readonly AsiWebToolsEnabled?: boolean
...
export type ToolKey = keyof typeof AsiDefaultTool
export type ToolValue = (typeof AsiDefaultTool)[ToolKey]
...
export function isValidAsiDefaultTool(tool: string): tool is AsiDefaultTool {
	return Object.values(AsiDefaultTool).includes(tool as AsiDefaultTool)
}
...
export interface VariantBuilder {
	...
	tools(...tools: AsiDefaultTool[]): this
	overrideTool(tool: AsiDefaultTool, override: ConfigOverride): this
