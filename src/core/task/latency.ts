...
const localCadenceOverride = readCadenceOverride("Asi_PRESENTATION_CADENCE_MS")
const remoteCadenceOverride = readCadenceOverride("Asi_REMOTE_PRESENTATION_CADENCE_MS")
const schedulingDisabled = readBooleanEnv("Asi_DISABLE_PRESENTATION_SCHEDULER")
