...
describe("multifile-diff", () => {
	...
	describe("showChangedFilesDiff", () => {
		...
		beforeEach(() => {
			messageStateHandlerStub.getAsiMessages.returns(mockMessages)
		})
		...
		it("should successfully show diff for changes since last task completion", async () => {
			...
			const messagesWithCompletion: AsiMessage[] = [
				{
					ts: 1234567000,
					type: "say",
			...
			messageStateHandlerStub.getAsiMessages.returns(messagesWithCompletion)
		...
		it("should handle message not found error", async () => {
			// Arrange
			messageStateHandlerStub.getAsiMessages.returns([])
		...
		it("should handle missing checkpoint hash", async () => {
			// Arrange
			const messagesWithoutHash: AsiMessage[] = [
				{
					ts: mockMessageTs,
					type: "say",
					say: "text",
			...
			messageStateHandlerStub.getAsiMessages.returns(messagesWithoutHash)
		...
		it("should use first checkpoint when no last completion found", async () => {
			// Arrange
			const messagesWithFirstCheckpoint: AsiMessage[] = [
				{
					ts: 1234567000,
					type: "say",
			...
			messageStateHandlerStub.getAsiMessages.returns(messagesWithFirstCheckpoint)
