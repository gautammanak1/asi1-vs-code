...
export class AutoApprove {
	...
	shouldAutoApproveTool(toolName: AsiDefaultTool): boolean | [boolean, boolean] {
		if (this.stateManager.getGlobalSettingsKey("yoloModeToggled")) {
			switch (toolName) {
				case AsiDefaultTool.FILE_READ:
				case AsiDefaultTool.LIST_FILES:
				case AsiDefaultTool.LIST_CODE_DEF:
				case AsiDefaultTool.SEARCH:
				case AsiDefaultTool.NEW_RULE:
				case AsiDefaultTool.FILE_NEW:
				case AsiDefaultTool.FILE_EDIT:
				case AsiDefaultTool.APPLY_PATCH:
				case AsiDefaultTool.BASH:
				case AsiDefaultTool.USE_SUBAGENTS:
					return [true, true]

				case AsiDefaultTool.BROWSER:
				case AsiDefaultTool.WEB_FETCH:
				case AsiDefaultTool.WEB_SEARCH:
				case AsiDefaultTool.MCP_ACCESS:
				case AsiDefaultTool.MCP_USE:
					return true
			}
		}
