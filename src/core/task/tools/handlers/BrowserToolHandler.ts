import { BrowserAction, BrowserActionResult, browserActions, AsiSayBrowserAction } from "@shared/ExtensionMessage"
...
export class BrowserToolHandler implements IFullyManagedTool {
	readonly name = AsiDefaultTool.BROWSER
			...
			if (action === "launch") {
				...
				if (autoApprover.shouldAutoApproveTool(block.name)) {
					...
					showNotificationForApproval(
						`Asi wants to use a browser and launch ${url}`,
