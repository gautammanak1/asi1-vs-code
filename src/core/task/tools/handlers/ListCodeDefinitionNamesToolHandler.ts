...
export class ListCodeDefinitionNamesToolHandler implements IFullyManagedTool {
	readonly name = AsiDefaultTool.LIST_CODE_DEF
	...
	async execute(config: TaskConfig, block: ToolUse): Promise<ToolResponse> {
		...
		if (shouldAutoApprove) {
			...
			const notificationMessage = `Asi wants to analyze code definitions in ${getWorkspaceBasename(absolutePath, "ListCodeDefinitionNamesToolHandler.notification")}`
