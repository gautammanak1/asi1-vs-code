...
import { AsiAssistantToolUseBlock, AsiStorageMessage, AsiTextContentBlock, AsiUserContent } from "@shared/messages"
...
function toAssistantToolUseBlock(call: SubagentToolCall): AsiAssistantToolUseBlock {
	return {
		type: "tool_use",
		id: call.toolUseId,
		name: call.name,
