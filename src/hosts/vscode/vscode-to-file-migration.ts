 ...
 * that data to the shared file-backed stores in ~/.Asi/data/ so all platforms
 ...
 *   globalStorageFsPath is still the VSCode-managed path (not ~/.Asi/data/),
 ...
 *   to ~/.Asi/data/ so that tasks created in VSCode are visible in CLI/JetBrains
