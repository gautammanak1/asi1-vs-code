 ...
 * GitOperations Class
 *
 * Handles git-specific operations for Asi's Checkpoints system.
 *
...
export class GitOperations {
	...
	public async initShadowGit(gitPath: string, cwd: string, taskId: string): Promise<string> {
		...
		await git.addConfig("user.name", "Asi Checkpoint")
		await git.addConfig("user.email", "checkpoint@Asi.bot")
