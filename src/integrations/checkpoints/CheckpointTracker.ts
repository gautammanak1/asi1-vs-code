 ...
 *
 * Core implementation of Asi's Checkpoints system that provides version control
...
class CheckpointTracker {
	 ...
	 *
	 * Configuration:
	 * - Respects 'Asi.enableCheckpoints' VS Code setting
	 */
	public static async create(
		...
		try {
			...
			try {
				...
				// Message substring is matched in webview CheckpointError.tsx for the Git install link.
	...
	public async commit(): Promise<string | undefined> {
		...
		try {
			...
			if (!lockResult.acquired && !lockResult.skipped) {
				throw new Error(
					"Failed to acquire checkpoint folder lock - another Asi instance may be performing checkpoint operations",
				)
			}
