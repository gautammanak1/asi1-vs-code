...
import type { AsiToolResponseContent } from "@shared/messages"
...
export interface CommandExecutorCallbacks {
	...
	/**
	 * Update a Asi message by index
	 * Supports updating commandCompleted status and/or text content
	 */
	updateAsiMessage: (index: number, updates: { commandCompleted?: boolean; text?: string }) => Promise<void>
	/** Get Asi messages array */
	getAsiMessages: () => Array<{ ask?: string; say?: string; text?: string }>
