...
import type { AsiError } from "../ClineError"
...
export interface IErrorProvider {
	 ...
	 */
	captureException(error: Error | AsiError, properties?: Record<string, unknown>): Promise<void>

	/**
	 * Sends a log message an error and optional properties
	 * @param error The error to log (Error or AsiError)
	 * @param properties Optional additional properties to attach
	 */
	logException(error: Error | AsiError, properties?: Record<string, unknown>): void
