 ...
 */
export const _GENERATED_MACHINE_ID_KEY = "Asi.generatedMachineId"
 ...
 * This is updated to Asi User ID when authenticated.
 */
 ...
 * If authenticated, this will be the Asi User ID.
