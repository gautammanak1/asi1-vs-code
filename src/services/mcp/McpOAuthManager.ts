...
/**
 * Implementation of OAuthClientProvider for Asi
 * Manages OAuth state and token storage for a single MCP server
 */
class AsiOAuthClientProvider implements OAuthClientProvider {
...
export class McpOAuthManager {
	...
	async getOrCreateProvider(serverName: string, serverUrl: string): Promise<OAuthClientProvider> {
		...
		// Create provider
		const provider = new AsiOAuthClientProvider(serverName, serverUrl)
