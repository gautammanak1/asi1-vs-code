...
export interface ITelemetryProvider {
	 ...
	 */
	identifyUser(userInfo: AsiAccountUserInfo, properties?: TelemetryProperties): void
	 ...
	 * @param name Metric name (e.g., "Asi.tokens.input")
	 ...
	 * Providers that don't support metrics may implement this as a no-op.
	 * @param name Metric name (e.g., "Asi.api.duration_seconds")
	 ...
	 * Providers that don't support metrics may implement this as a no-op.
	 * @param name Metric name (e.g., "Asi.workspace.active_roots")
