...
import type { AsiAccountUserInfo } from "../../../auth/AuthService"
...
export class OpenTelemetryTelemetryProvider implements ITelemetryProvider {
	...
	constructor(
		...
		if (meterProvider) {
			this.meter = meterProvider.getMeter("Asi")
			this.meterProvider = meterProvider
		}

		if (loggerProvider) {
			this.logger = loggerProvider.getLogger("Asi")
	...
	public identifyUser(userInfo: AsiAccountUserInfo, properties: TelemetryProperties = {}): void {
	 ...
	 */
	private buildUserAttributes(userInfo: AsiAccountUserInfo, properties: TelemetryProperties = {}): Record<string, string> {
