...
/**
 * Combines API request start and finish messages in an array of AsiMessages.
 *
 ...
 * @returns A new array of AsiMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: AsiMessage[]): AsiMessage[] {
	const combinedApiRequests: AsiMessage[] = []
