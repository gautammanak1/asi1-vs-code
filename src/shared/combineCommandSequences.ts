...
/**
 * Combines sequences of command and command_output messages in an array of AsiMessages.
 *
 * This function processes an array of AsiMessages objects, looking for sequences
 ...
 * their text contents.
 *
 * @param messages - An array of AsiMessage objects to process.
 * @returns A new array of AsiMessage objects with command sequences combined.
 *
 * @example
 ...
 */
export function combineCommandSequences(messages: AsiMessage[]): AsiMessage[] {
	const combinedCommands: AsiMessage[] = []
