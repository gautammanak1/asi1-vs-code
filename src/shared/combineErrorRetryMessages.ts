 ...
 * @returns A new array of AsiMessage objects with error_retry sequences consolidated.
 *
 * @example
 ...
 */
export function combineErrorRetryMessages(messages: AsiMessage[]): AsiMessage[] {
