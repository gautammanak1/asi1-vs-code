...
/**
 * Calculates API metrics from an array of AsiMessages.
 *
 ...
 */
export function getApiMetrics(messages: AsiMessage[]): ApiMetrics {
 ...
 */
export function getLastApiReqTotalTokens(messages: AsiMessage[]): number {
