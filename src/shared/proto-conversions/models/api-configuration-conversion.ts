...
export function convertApiConfigurationToProto(
	...
	return {
		...
		planModeClineModelInfo: convertModelInfoToProtoOpenRouter(
			config.planModeAsiModelInfo,
		),
		...
		actModeClineModelInfo: convertModelInfoToProtoOpenRouter(
			config.actModeAsiModelInfo,
		),
...
export function convertProtoToApiConfiguration(
	...
	return {
		...
		planModeReasoningEffort: protoConfig.planModeReasoningEffort as
		...
		planModeAsiModelInfo: convertProtoToModelInfo(
			protoConfig.planModeClineModelInfo,
		),
		...
		actModeReasoningEffort: protoConfig.actModeReasoningEffort as
			| OpenaiReasoningEffort
			| undefined,
		...
		actModeAsiModelInfo: convertProtoToModelInfo(
			protoConfig.actModeClineModelInfo,
		),
