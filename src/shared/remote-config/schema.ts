...
// Asi Provider model schema with per-model settings
export const AsiModelSchema = z.object({
	id: z.string(), // The model ID is required
})

// Asi Provider specific settings
export const AsiSettingsSchema = z.object({
	// A list of the allowed models with their settings
	models: z.array(AsiModelSchema).optional(),
})
...
const ProviderSettingsSchema = z.object({
	...
	Asi: AsiSettingsSchema.optional(),
...
// Settings for a global Asi rules or workflow file.
