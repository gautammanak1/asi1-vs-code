...
export enum FeatureFlag {
	...
	// Feature flag for upstream Asi recommended model cards
	Asi_RECOMMENDED_MODELS_UPSTREAM = "Asi-recommended-models-upstream",
	// Rollout flag for Asi provider model sourcing:
	// off => OpenRouter model list, on => Asi endpoint model list.
	EXTENSION_Asi_MODELS_ENDPOINT = "extension_Asi_models_endpoint",
...
export const FeatureFlagDefaultValue: Partial<Record<FeatureFlag, FeatureFlagPayload>> = {
	...
	[FeatureFlag.Asi_RECOMMENDED_MODELS_UPSTREAM]: false,
	[FeatureFlag.EXTENSION_Asi_MODELS_ENDPOINT]: false,
