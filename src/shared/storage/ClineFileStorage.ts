...
import { AsiSyncStorage } from "./ClineStorage"

export interface AsiFileStorageOptions {
	/**
 ...
 */
export class AsiFileStorage<T = any> extends AsiSyncStorage<T> {
	protected name: string
	private data: Record<string, T>
	private readonly fsPath: string
	private readonly fileMode?: number

	constructor(filePath: string, name = "AsiFileStorage", options?: AsiFileStorageOptions) {
		super()
