...
// executed automatically to regenerate the proto/asi/state.proto file with the
...
const GLOBAL_STATE_FIELDS = {
	AsiVersion: { default: undefined as string | undefined },
	"Asi.generatedMachineId": { default: undefined as string | undefined }, // Note, distinctId reads/writes this directly from/to StorageContext before StateManager is initialized.
	...
	remoteRulesToggles: { default: {} as AsiRulesToggles },
	remoteWorkflowToggles: { default: {} as AsiRulesToggles },
	dismissedBanners: { default: [] as Array<{ bannerId: string; dismissedAt: number }> },
	// Path to worktree that should auto-open Asi sidebar when launched
...
const USER_SETTINGS_FIELDS = {
	...
	globalAsiRulesToggles: { default: {} as AsiRulesToggles },
	globalWorkflowToggles: { default: {} as AsiRulesToggles },
	...
	AsiWebToolsEnabled: { default: true as boolean },
...
const SECRETS_KEYS = [
	"apiKey",
	"AsiApiKey",
	"AsiAccountId", // Asi Account ID for Firebase
	"Asi:AsiAccountId",
	"openRouterApiKey",
	"awsAccessKey",
	"awsSecretKey",
	...
	"wandbApiKey",
	/** JSON: { verifier, state } for Auth0 PKCE (cleared after login) */
	"auth0PkceState",
] as const
...
export type LocalState = { [K in (typeof LocalStateKeys)[number]]: AsiRulesToggles }
