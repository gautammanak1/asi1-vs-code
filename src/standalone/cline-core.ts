...
function setupHostProvider(extensionContext: any, extensionDir: string, dataDir: string) {
	...
	// Asi-core expects the binaries to be unpacked in the directory where it is running.
...
/**
 * Gracefully shutdown the Asi-core process by:
...
function showHelp() {
	Logger.log(`
Asi Core - Standalone Server

Usage: node Asi-core.js [options]
...
Options:
  ...
  -c, --config <path>            Directory for Asi data storage (default: ~/.Asi)
