...
import type { AsiAPI } from "../exports/cline.d.ts"
import { setVscodeHostProviderMock } from "./host-provider-test-utils"

describe("AsiAPI Core Functionality", () => {
	let api: AsiAPI
	...
	beforeEach(async () => {
		...
		// Create a mock controller that matches what the real createAsiAPI expects
		...
		// Create API instance
		api = createAsiAPI(mockController)
	})
