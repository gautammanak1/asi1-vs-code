...
export const addSelectedCodeToAsiWebview = async (_page: Page) => {
	...
	const addToAsi = _page.getByText(/Add to Asi/i)
	await addToAsi.waitFor({ state: "visible" })
