...
//
// These helpers spawn Asi as a child process and return stdout, stderr,
// and exit code — without going through the TUI harness. Use these for:
//   - Exit code assertions
//   - Pure stdout/stderr contract tests
//   - Piped stdin tests (echo "..." | Asi -y ...)
//   - JSON output validation
//   - Timeout behavior
// ---------------------------------------------------------------------------

import { SpawnSyncOptions, spawnSync } from "child_process"
import { Asi_BIN } from "./constants.js"
import { AsiEnv } from "./env.js"
...
/**
 * Run `Asi [args]` synchronously and return stdout/stderr/exitCode.
 *
 * Suitable for deterministic, fast-exiting commands like:
 *   Asi --help, Asi --version, Asi auth -p ... -k ..., etc.
 */
export function runAsi(args: string[], opts: RunOptions = {}): RunResult {
	...
	const spawnOpts: SpawnSyncOptions = {
		...
		timeout,
		cwd,
		env: { ...AsiEnv(config), ...extraEnv },
		input: stdin,
	}

	const result = spawnSync(Asi_BIN, args, spawnOpts)
...
/**
 * Assert that a runAsi result exited with the expected code.
