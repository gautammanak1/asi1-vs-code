...
//
// Covers:
//   - `Asi` launches interactive view (authed / unauthed)
...
// ---------------------------------------------------------------------------
// Asi (unauthenticated) → shows interactive auth view
// ---------------------------------------------------------------------------
test.describe("Asi (unauthenticated) — shows auth view", () => {
	test.use({
...
// ---------------------------------------------------------------------------
// Asi (authenticated) → shows main chat view
// ---------------------------------------------------------------------------
test.describe("Asi (authenticated) — shows chat view", () => {
	test.use({
		program: { file: Asi_BIN, args: ["--tui"] },
		...TERMINAL_WIDE,
