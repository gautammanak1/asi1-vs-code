...
import { Asi_ONBOARDING_MODELS } from "@shared/asi/onboarding"
import type { AsiMessage, AsiSayTool } from "@shared/ExtensionMessage"
...
const meta: Meta<typeof MockApp> = {
	...
	parameters: {
		...
		docs: {
			description: {
				component: `
The ChatView component is the main interface for interacting with Asi. It provides a comprehensive chat experience with AI assistance, task management, and various tools.
...
const createMessage = (
	minutesAgo: number,
	type: AsiMessage["type"],
	say: AsiMessage["say"],
	text: string,
	overrides: Partial<AsiMessage> = {},
): AsiMessage => ({
...
const mockActiveMessages: AsiMessage[] = [
...
const mockStreamingMessages: AsiMessage[] = [
	...mockActiveMessages,
	createMessage(
		0.17,
		"say",
...
const createMockState = (overrides: any = {}) => ({
	...
	showWelcome: false,
	AsiMessages: mockActiveMessages,
...
export const Welcome: Story = {
	decorators: [createStoryDecorator({ welcomeViewCompleted: false, showWelcome: true, AsiMessages: [] })],
	parameters: {
		docs: {
			description: {
...
export const Onboarding: Story = {
	decorators: [
		createStoryDecorator({
			...
			showWelcome: true,
			AsiMessages: [],
			onboardingModels: { models: Asi_ONBOARDING_MODELS },
		}),
	],
	parameters: {
		docs: {
	...
	play: async ({ canvasElement }) => {
		...
		const title = canvas.getByText("How will you use Asi?")
		...
		await expect(canvas.getByText("How will you use Asi?")).toBeInTheDocument()
...
export const EmptyState: Story = {
	decorators: [createStoryDecorator({ AsiMessages: [], taskHistory: [], isNewUser: true, showAnnouncement: true })],
	parameters: {
		docs: {
			description: {
...
export const ReturnUser: Story = {
	decorators: [
		createStoryDecorator({ AsiMessages: [], taskHistory: mockTaskHistory, isNewUser: true, showAnnouncement: false }),
	],
	parameters: {
		docs: {
			description: {
...
export const ActiveConversation: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "An active conversation showing a typical interaction with Asi, including task creation, tool usage, and AI responses.",
			},
		},
	},
}
...
export const StreamingResponse: Story = {
	decorators: [createStoryDecorator({ AsiMessages: mockStreamingMessages })],
	parameters: {
		docs: {
			description: {
...
const createLongMessages = (): AsiMessage[] => [
...
export const LongConversation: Story = {
	decorators: [createStoryDecorator({ AsiMessages: createLongMessages() })],
	parameters: {
		docs: {
			description: {
...
export const ErrorState: Story = {
	decorators: [createStoryDecorator({ AsiMessages: createErrorMessages() })],
	parameters: {
		docs: {
			description: {
				story: "Shows how Asi handles and displays error messages, helping users understand and resolve issues.",
			},
		},
	},
}
...
export const AutoApprovalEnabled: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Shows the interface with auto-approval enabled, allowing Asi to execute certain actions automatically without user confirmation.",
			},
		},
	},
}
...
export const PlanMode: Story = {
	decorators: [
		createStoryDecorator({
			AsiMessages: createPlanModeMessages(),
	...
	parameters: {
		docs: {
			description: {
				story: "Shows Asi in Plan mode, where it focuses on creating detailed plans and discussing approaches before implementation.",
			},
		},
	},
}
...
export const BrowserAutomation: Story = {
	decorators: [createStoryDecorator({ AsiMessages: createBrowserMessages() })],
	parameters: {
		docs: {
			description: {
				story: "Shows Asi performing browser automation tasks, including launching browsers, clicking elements, and testing web applications.",
			},
		},
	},
}
...
export const ToolApproval: Story = {
	decorators: [createStoryDecorator({ AsiMessages: createToolApprovalMessages() })],
	parameters: {
		docs: {
			description: {
...
export const Followup = quickStory(
	...
	"Shows followup question state where Asi asks for next steps.",
)
...
export const PlanModeResponse = quickStory(
	...
	"plan_mode_respond",
	"Here's my comprehensive plan for refactoring your React application with TypeScript migration and performance optimization phases.\n\n\n\n\nPhase 1: TypeScript Migration\n1. Set up TypeScript in the project\n2. Rename .js files to .tsx/.ts\n3. Add type definitions for components and props\n4. Fix type errors and ensure type safety\n\nPhase 2: Performance Optimization\n1. Analyze current performance bottlenecks\n2. Implement code-splitting and lazy loading\n3. Optimize rendering with React.memo and useCallback\n4. Minimize bundle size with tree-shaking and minification\n5. Test performance improvements using profiling tools",
	"Shows plan mode response where Asi presents a detailed plan for user approval.",
)
...
export const ReportBug = quickStory(
	...
	"report_bug",
	JSON.stringify({
		steps_to_reproduce: "1. Open Asi\n2. Start a new task\n3. Observe the error",
		what_happened: "Asi crashes unexpectedly",
	}),
...
export const DiffEditNewFormat: Story = {
	decorators: [createStoryDecorator({ backgroundEditEnabled: true, AsiMessages: createNewFormatMultiFileMessages() })],
	parameters: {
		docs: {
			description: {
...
export const DiffEditNewFormatStreaming: Story = {
	decorators: [
		(Story) => {
			const [messages, setMessages] = useState<AsiMessage[]>([
			...
			const mockState = useMemo(() => createMockState({ backgroundEditEnabled: true, AsiMessages: messages }), [messages])
...
export const DiffEditReplaceDiffFormat: Story = {
	decorators: [createStoryDecorator({ backgroundEditEnabled: true, AsiMessages: createReplaceDiffFormatPatchMessages() })],
	parameters: {
		docs: {
			description: {
...
export const DiffEditMixedFormats: Story = {
	decorators: [createStoryDecorator({ AsiMessages: createMixedFormatMessages() })],
	parameters: {
		docs: {
			description: {
