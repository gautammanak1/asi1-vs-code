...
const FEATURE_TIPS: FeatureTipItem[] = [
	{
		text: 'Enable "Double-Check Completion" in settings to have Asi verify its work before finishing a task.',
	},
	{
		text: "Add a .Asirules file to your project root to give Asi project-specific instructions.",
	},
	{
		text: "Switch to Plan Mode to discuss and plan an approach before Asi takes action.",
	},
	{
		text: "Use @ in the chat input to add files, folders, or URLs as context for your task.",
	},
	{
		text: "Set up MCP Servers to give Asi access to external tools and APIs.",
	},
	{
		text: "Asi creates checkpoints after changes — you can always restore to a previous state.",
	},
	{
	...
	{
		text: "Use the quote button to select text from Asi's response and reference it in your reply.",
	},
	{
		text: "You can drag and drop images into the chat to share screenshots with Asi.",
	},
	{
		text: "Asi can browse websites — ask it to test your local dev server in the browser.",
	},
	{
 ...
 * Appears after a brief delay and cycles through tips while Asi is thinking.
 */
