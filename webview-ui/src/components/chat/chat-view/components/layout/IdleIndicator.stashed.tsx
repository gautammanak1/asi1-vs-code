 ...
 */
export function useIdleIndicator(scrollContainerRef: React.RefObject<HTMLDivElement>, AsiMessages: AsiMessage[]): boolean {
	...
	useEffect(() => {
		...
		const isTaskComplete = AsiMessages.some(
	...
	}, [scrollContainerRef, AsiMessages])
