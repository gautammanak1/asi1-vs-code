 ...
 */
export function buildToolsWithReasoning(messages: AsiMessage[]): ToolWithReasoning[] {
 ...
 */
export function getToolGroupSummaryFromParsedTools(tools: AsiSayTool[]): string {
