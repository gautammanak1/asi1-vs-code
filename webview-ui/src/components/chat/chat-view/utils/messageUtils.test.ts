...
const createTextMessage = (ts: number, text: string): AsiMessage => ({
	type: "say",
	say: "text",
	text,
	ts,
...
const createToolMessage = (ts: number, tool: string): AsiMessage => ({
	type: "say",
	say: "tool",
...
const createReasoningMessage = (ts: number, text: string): AsiMessage => ({
	type: "say",
	say: "reasoning",
	text,
	ts,
