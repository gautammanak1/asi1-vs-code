...
- Official documentation: https://github.com/gautammanak1/asi1-vs-code
- API reference: https://api.asi1.ai/docs
- Support forum: https://fetch.ai

You can also visit our website at https://fetch.ai for more information.`,
		compact: false,
		showCursor: false,
	},
	parameters: {
