import type { BannerAction, BannerCardData } from "@shared/asi/banner"
...
export const WhatsNewItems: React.FC<WhatsNewItemsProps> = ({
	...
	onClose,
	inlineCodeStyle,
	onNavigateToModelPicker: _onNavigateToModelPicker,
}) => {
	...
	return (
		<ul className="text-sm pl-3 list-disc" style={{ color: "var(--vscode-descriptionForeground)" }}>
			{hasWelcomeBanners ? (
				...
				<li className="mb-2">Configure your API under Settings → API when you need to.</li>
			)}
		</ul>
	)
}
