...
export function getAsiUIOnboardingGroups(groupedModels: OnboardingModelGroup): OnboardingModelsByGroup {
...
export function getPriceRange(_modelInfo: OpenRouterModelInfo): string {
	return "Free"
}
