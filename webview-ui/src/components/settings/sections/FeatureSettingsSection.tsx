...
const agentFeatures: FeatureToggle[] = [
	{
		id: "subagents",
		label: "Subagents",
		description: "Let Asi run focused subagents in parallel to explore the codebase for you.",
...
const editorFeatures: FeatureToggle[] = [
	{
		...
		label: "Feature Tips",
		description: "Show rotating tips during the thinking phase to help you discover Asi features.",
	...
	},
	{
		id: "worktrees",
		label: "Worktrees",
		description: "Enables git worktree management for running parallel Asi tasks.",
...
const experimentalFeatures: FeatureToggle[] = [
	...
	},
	{
		...
		description: "Sometimes Asi just isn't feeling it today. For entertainment purposes only.",
...
const FeatureSettingsSection = ({ renderSectionHeader }: FeatureSettingsSectionProps) => {
	...
	const handleFocusChainIntervalChange = useCallback(
		(value: number) => {
			updateSetting("focusChainSettings", { ...focusChainSettings, remindAsiInterval: value })
		},
		[focusChainSettings],
	)
