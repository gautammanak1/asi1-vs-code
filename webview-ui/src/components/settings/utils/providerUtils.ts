...
function pick<C extends ApiConfiguration, K extends keyof C>(config: C, mode: Mode, planKey: K, actKey: K): C[K] {
...
export function getModeSpecificFields(apiConfiguration: ApiConfiguration | undefined, mode: Mode) {
	...
	const openRouterModelId = pick(c, mode, "planModeOpenRouterModelId", "actModeOpenRouterModelId")
	const openRouterModelInfo = pick(c, mode, "planModeOpenRouterModelInfo", "actModeOpenRouterModelInfo")
	...
	return {
		...
		openAiModelId: pick(c, mode, "planModeOpenAiModelId", "actModeOpenAiModelId"),
		openAiModelInfo: pick(c, mode, "planModeOpenAiModelInfo", "actModeOpenAiModelInfo"),
		openRouterModelId,
		openRouterModelInfo,
		AsiModelId: pick(c, mode, "planModeAsiModelId", "actModeAsiModelId") || openRouterModelId,
		AsiModelInfo: pick(c, mode, "planModeAsiModelInfo", "actModeAsiModelInfo") || openRouterModelInfo,
		togetherModelId: pick(c, mode, "planModeTogetherModelId", "actModeTogetherModelId"),
		fireworksModelId: pick(c, mode, "planModeFireworksModelId", "actModeFireworksModelId"),
		lmStudioModelId: pick(c, mode, "planModeLmStudioModelId", "actModeLmStudioModelId"),
		ollamaModelId: pick(c, mode, "planModeOllamaModelId", "actModeOllamaModelId"),
		liteLlmModelId: pick(c, mode, "planModeLiteLlmModelId", "actModeLiteLlmModelId"),
		liteLlmModelInfo: pick(c, mode, "planModeLiteLlmModelInfo", "actModeLiteLlmModelInfo"),
		requestyModelId: pick(c, mode, "planModeRequestyModelId", "actModeRequestyModelId"),
		requestyModelInfo: pick(c, mode, "planModeRequestyModelInfo", "actModeRequestyModelInfo"),
		groqModelId: pick(c, mode, "planModeGroqModelId", "actModeGroqModelId"),
		groqModelInfo: pick(c, mode, "planModeGroqModelInfo", "actModeGroqModelInfo"),
		basetenModelId: pick(c, mode, "planModeBasetenModelId", "actModeBasetenModelId"),
		basetenModelInfo: pick(c, mode, "planModeBasetenModelInfo", "actModeBasetenModelInfo"),
		huggingFaceModelId: pick(c, mode, "planModeHuggingFaceModelId", "actModeHuggingFaceModelId"),
		huggingFaceModelInfo: pick(c, mode, "planModeHuggingFaceModelInfo", "actModeHuggingFaceModelInfo"),
		vsCodeLmModelSelector: pick(c, mode, "planModeVsCodeLmModelSelector", "actModeVsCodeLmModelSelector"),
		aihubmixModelId: pick(c, mode, "planModeAihubmixModelId", "actModeAihubmixModelId"),
		aihubmixModelInfo: pick(c, mode, "planModeAihubmixModelInfo", "actModeAihubmixModelInfo"),
		hicapModelId: pick(c, mode, "planModeHicapModelId", "actModeHicapModelId"),
		hicapModelInfo: pick(c, mode, "planModeHicapModelInfo", "actModeHicapModelInfo"),
		nousResearchModelId: pick(c, mode, "planModeNousResearchModelId", "actModeNousResearchModelId"),
		...
		huaweiCloudMaasModelId: pick(c, mode, "planModeHuaweiCloudMaasModelId", "actModeHuaweiCloudMaasModelId"),
		huaweiCloudMaasModelInfo: pick(c, mode, "planModeHuaweiCloudMaasModelInfo", "actModeHuaweiCloudMaasModelInfo"),
		awsBedrockCustomSelected: pick(c, mode, "planModeAwsBedrockCustomSelected", "actModeAwsBedrockCustomSelected"),
		awsBedrockCustomModelBaseId: pick(c, mode, "planModeAwsBedrockCustomModelBaseId", "actModeAwsBedrockCustomModelBaseId"),
		thinkingBudgetTokens: pick(c, mode, "planModeThinkingBudgetTokens", "actModeThinkingBudgetTokens"),
		reasoningEffort: pick(c, mode, "planModeReasoningEffort", "actModeReasoningEffort"),
	}
}
